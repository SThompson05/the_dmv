...
RSpec.describe facility_1 do
  before(:each) do
    ...
    @facility_2 = facility_1.new({name: 'DMV Northeast Branch', address: '4685 Peoria Street Suite 101 Denver CO 80239', phone: '(720) 865-4600'})
  ...
  describe '#initialize' do
    it 'can initialize' do
      expect(@facility_1).to be_an_instance_of(facility_1)
